...
public class CinemaInitServiceImpl implements ICinemaInitService {
	...
	public void initVilles() {
		Stream.of("Dakar", "Saint Louis", "Thies", "Diourbel").forEach(nameVille->{
	...
	public void initCinemas() {
		villeRepository.findAll().forEach(v->{
			Stream.of("Canal Olympia", "Christa", "Sor", "Athie Cree", "Solution Expert")
			.forEach(nameCinema->{
	...
	public void initCategories() {
		Stream.of("Histoire", "Actions", "Fiction", "Dramatique").forEach(cat->{
	...
	public void initFilms() {
		...
		Stream.of("Game of Thrones", "Prison Break", "Survivor Designated", "Casa del Papel", "Cat Women")
		.forEach(titreFilm->{
			Film film=new Film();
	...
	public void initProjections() {
		double[] prices=new double[] {1500,2000,2500,3000,3500};
